...
⚠️ **`eval.judge.kappa_vs_human` lives in the bundle, not only in a report.** A
...
⚠️ The cost: keeping the previous version for rollback means holding **two**
...
⚠️ **Known blind spot, and it bit once.** The check does not compare *library*
